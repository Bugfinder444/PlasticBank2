...
public class Branches extends BaseClass {
	...
	@CacheLookup
	private WebElement verifyNameText;

	@FindBy(xpath = "//input[@name='name']")
	@CacheLookup
	private WebElement editNameTextFeild;
	...
	public static WebElement exportButtonBranch;
...
//		}
	...
	public void reportDownloadBranchList(String fileName) throws InterruptedException {

		WebDriverWait wait = new WebDriverWait(alcDriver, Duration.ofSeconds(240));
