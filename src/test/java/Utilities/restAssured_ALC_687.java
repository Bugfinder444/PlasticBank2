...
public class restAssured_ALC_687 {
...
//LOGIN----FOR-----BRANCH-----------B1-----------------------------------------------------------------------------------------------------------------
                ...
                Response responseloginB1 = RestAssured.given()
                        ...
                        .post("/login"); // Endpoint
                String token1 = responseloginB1.jsonPath().getString("token");
...
//ADD MATERIALS----BRANCH------------------------------------------------------------------------------------------------
                ...
                String branchPCGidB1 = responseItem1.path("id");
...
// Process the response as needed
        System.out.println("Response: " + response5.body().asString());
                ...
                Response responseloginB2 = RestAssured.given()
                        ...
                        .post("/login"); // Endpoint
                String token2 = responseloginB2.jsonPath().getString("token");
...
//ADD MATERIALS----BRANCH------------------b2------------------------------------------------------------------------------
        ...
        //Create member for Branch 1....    M6 ---> B3
...
// Process the response as needed
        System.out.println("Response: " + response6.body().asString());
                ...
                Response responseloginB3 = RestAssured.given()
                        ...
                        .post("/login"); // Endpoint
                String token3 = responseloginB3.jsonPath().getString("token");
        ...
        //Create member for Branch 1....    M7 ---> B4
...
// Process the response as needed
        System.out.println("Response: " + response7.body().asString());
                ...
                Response responseloginB4 = RestAssured.given()
                        ...
                        .post("/login"); // Endpoint
                String token7 = responseloginB4.jsonPath().getString("token");
...
// Process the response as needed
        System.out.println("Response: " + response8.body().asString());
                ...
                Response responseloginB5 = RestAssured.given()
                        ...
                        .post("/login"); // Endpoint
                String token8 = responseloginB5.jsonPath().getString("token");
