...
public class auditTrailReport_2627 extends BaseClass{
    ...
    public auditTrailReport_2627(WebDriver alcDriver) {

        PageFactory.initElements(alcDriver, this);
    }

    public void run(String url,String searchName) throws InterruptedException {

        downloadFile(url);
        findAndOpenSearch(searchName);
        deleteFile();
    ...
    public static void findAndOpenSearch(String searchName) {
                ...
                for (Cell cell : row) {
                    if (cell.getCellType() == CellType.STRING) {
                        ...
                        if (cellValue.contains(searchString)) {
                            ...
                            Allure.addAttachment("In Bonus Order : | ","Found '" + searchString + "' in Excel at Row: " + (row.getRowNum() + 1) + ", Column: " + (cell.getColumnIndex() + 1));
